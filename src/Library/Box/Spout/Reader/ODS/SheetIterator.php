...
class SheetIterator implements IteratorInterface
{
    ...
    /** @var \App\Library\Box\Spout\Common\Escaper\ODS Used to unescape XML data */
    protected $escaper;
     ...
     * @throws \App\Library\Box\Spout\Reader\Exception\NoSheetsFoundException If there are no sheets in the file
     */
    public function __construct($filePath, $shouldFormatDates)
    {
        ...
        $this->escaper = \App\Library\Box\Spout\Common\Escaper\ODS::getInstance();
    }
     ...
     *
     * @return void
     * @throws \App\Library\Box\Spout\Common\Exception\IOException If unable to open the XML file containing sheets' data
     */
     ...
     *
     * @return \App\Library\Box\Spout\Reader\ODS\Sheet
     */
