...
namespace App\Library\Box\Spout\Reader\ODS;

use App\Library\Box\Spout\Common\Exception\IOException;
use App\Library\Box\Spout\Reader\Exception\IteratorNotRewindableException;
use App\Library\Box\Spout\Reader\Exception\XMLProcessingException;
use App\Library\Box\Spout\Reader\IteratorInterface;
use App\Library\Box\Spout\Reader\ODS\Helper\CellValueFormatter;
use App\Library\Box\Spout\Reader\Wrapper\XMLReader;

/**
 * Class RowIterator
 *
 * @package App\Library\Box\Spout\Reader\ODS
 */
class RowIterator implements IteratorInterface
{
    ...
    /** @var \App\Library\Box\Spout\Reader\Wrapper\XMLReader The XMLReader object that will help read sheet's XML data */
    protected $xmlReader;
     ...
     *
     * @return void
     * @throws \App\Library\Box\Spout\Reader\Exception\IteratorNotRewindableException If the iterator is rewound more than once
     */
     ...
     *
     * @return void
     * @throws \App\Library\Box\Spout\Reader\Exception\SharedStringNotFoundException If a shared string was not found
     * @throws \App\Library\Box\Spout\Common\Exception\IOException If unable to read the sheet data XML
     */
