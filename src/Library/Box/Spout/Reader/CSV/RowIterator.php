...
namespace App\Library\Box\Spout\Reader\CSV;

use App\Library\Box\Spout\Reader\IteratorInterface;
use App\Library\Box\Spout\Common\Helper\EncodingHelper;

/**
 * Class RowIterator
 * Iterate over CSV rows.
 *
 * @package App\Library\Box\Spout\Reader\CSV
 */
class RowIterator implements IteratorInterface
{
    ...
    /** @var \App\Library\Box\Spout\Common\Helper\EncodingHelper Helper to work with different encodings */
     ...
     *
     * @return void
     * @throws \App\Library\Box\Spout\Common\Exception\EncodingConversionException If unable to convert data to UTF-8
     */
