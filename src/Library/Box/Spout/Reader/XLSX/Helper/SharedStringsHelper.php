...
namespace App\Library\Box\Spout\Reader\XLSX\Helper;

use App\Library\Box\Spout\Common\Exception\IOException;
use App\Library\Box\Spout\Reader\Exception\XMLProcessingException;
use App\Library\Box\Spout\Reader\Wrapper\SimpleXMLElement;
use App\Library\Box\Spout\Reader\Wrapper\XMLReader;
use App\Library\Box\Spout\Reader\XLSX\Helper\SharedStringsCaching\CachingStrategyFactory;
use App\Library\Box\Spout\Reader\XLSX\Helper\SharedStringsCaching\CachingStrategyInterface;

/**
 * Class SharedStringsHelper
 * This class provides helper functions for reading sharedStrings XML file
 *
 * @package App\Library\Box\Spout\Reader\XLSX\Helper
 */
class SharedStringsHelper
{
     ...
     *
     * @return void
     * @throws \App\Library\Box\Spout\Common\Exception\IOException If sharedStrings.xml can't be read
     */
    public function extractSharedStrings()
    {
        ...
        $escaper = \App\Library\Box\Spout\Common\Escaper\XLSX::getInstance();
     ...
     *
     * @param \App\Library\Box\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader instance
     * @return int Number of unique shared strings in the sharedStrings.xml file
     * @throws \App\Library\Box\Spout\Common\Exception\IOException If sharedStrings.xml is invalid and can't be read
     */
     ...
     *
     * @param \App\Library\Box\Spout\Reader\Wrapper\XMLReader $xmlReader
     * @return \App\Library\Box\Spout\Reader\Wrapper\SimpleXMLElement
     * @throws \App\Library\Box\Spout\Common\Exception\IOException If the current node cannot be read
     */
     ...
     *
     * @param \App\Library\Box\Spout\Reader\Wrapper\SimpleXMLElement $parentNode Parent node that may contain nodes to remove
     * @return \App\Library\Box\Spout\Reader\Wrapper\SimpleXMLElement Cleaned parent node
     */
     ...
     *
     * @param \App\Library\Box\Spout\Reader\Wrapper\SimpleXMLElement $textNode The text node element (<t>) whitespace may be preserved
     ...
     * @throws \App\Library\Box\Spout\Reader\Exception\SharedStringNotFoundException If no shared string found for the given index
     */
