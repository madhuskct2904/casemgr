...
namespace App\Library\Box\Spout\Writer\ODS\Internal;
...
use App\Library\Box\Spout\Common\Helper\StringHelper;
 ...
 *
 * @package App\Library\Box\Spout\Writer\ODS\Internal
 */
class Worksheet implements WorksheetInterface
{
    ...
    /** @var \App\Library\Box\Spout\Common\Escaper\ODS Strings escaper */
    protected $stringsEscaper;

    /** @var \App\Library\Box\Spout\Common\Helper\StringHelper To help with string manipulation */
    ...
    public function __construct($externalSheet, $worksheetFilesFolder)
    {
        ...
        $this->stringsEscaper = \App\Library\Box\Spout\Common\Escaper\ODS::getInstance();
