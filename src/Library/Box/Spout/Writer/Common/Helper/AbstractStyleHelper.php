...
namespace App\Library\Box\Spout\Writer\Common\Helper;

/**
 * Class AbstractStyleHelper
 * This class provides helper functions to manage styles
 *
 * @package App\Library\Box\Spout\Writer\Common\Helper
 */
abstract class AbstractStyleHelper
{
    ...
    /**
     * @param \App\Library\Box\Spout\Writer\Style\Style $defaultStyle
     */
     ...
     *
     * @param \App\Library\Box\Spout\Writer\Style\Style $style The style to be registered
     * @return \App\Library\Box\Spout\Writer\Style\Style The registered style, updated with an internal ID.
     */
     ...
     *
     * @param \App\Library\Box\Spout\Writer\Style\Style $style
     * @return bool
     */
     ...
     * @return \App\Library\Box\Spout\Writer\Style\Style
     */
    ...
    /**
     * @return \App\Library\Box\Spout\Writer\Style\Style[] List of registered styles
     */
     ...
     *
     * @return \App\Library\Box\Spout\Writer\Style\Style Default style
     */
     ...
     *
     * @param \App\Library\Box\Spout\Writer\Style\Style $style The original style
     * @param array $dataRow The row the style will be applied to
     * @return \App\Library\Box\Spout\Writer\Style\Style The updated style
     */
...
//        $updatedStyle = $this->applyWrapTextIfCellContainsNewLine($style, $dataRow);
     ...
     * @param \App\Library\Box\Spout\Writer\Style\Style $style The original style
     * @param array $dataRow The row the style will be applied to
     * @return \App\Library\Box\Spout\Writer\Style\Style The eventually updated style
     */
