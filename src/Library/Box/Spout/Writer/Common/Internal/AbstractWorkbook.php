...
use App\Library\Box\Spout\Writer\Exception\SheetNotFoundException;
 ...
 *
 * @package App\Library\Box\Spout\Writer\Common
 */
abstract class AbstractWorkbook implements WorkbookInterface
{
    ...
    /**
     * @return \App\Library\Box\Spout\Writer\Common\Helper\AbstractStyleHelper The specific style helper
     */
     ...
     * The writing will resume where it stopped (i.e. data won't be truncated).
     *
     * @param \App\Library\Box\Spout\Writer\Common\Sheet $sheet The "external" sheet to set as current
     * @return void
     * @throws \App\Library\Box\Spout\Writer\Exception\SheetNotFoundException If the given sheet does not exist in the workbook
     */
     ...
     *
     * @param \App\Library\Box\Spout\Writer\Common\Sheet $sheet
     ...
     * @param \App\Library\Box\Spout\Writer\Style\Style $style Style to be applied to the row.
     * @return void
     * @throws \App\Library\Box\Spout\Common\Exception\IOException If trying to create a new sheet and unable to open the sheet for writing
     * @throws \App\Library\Box\Spout\Writer\Exception\WriterException If unable to write data
     */
