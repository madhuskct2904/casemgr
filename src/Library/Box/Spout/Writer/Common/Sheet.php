...
namespace App\Library\Box\Spout\Writer\Common;

use App\Library\Box\Spout\Common\Helper\StringHelper;
use App\Library\Box\Spout\Writer\Exception\InvalidSheetNameException;
...
class Sheet
{
    ...
    /** @var \App\Library\Box\Spout\Common\Helper\StringHelper */
     ...
     * @return Sheet
     * @throws \App\Library\Box\Spout\Writer\Exception\InvalidSheetNameException If the sheet's name is invalid.
     */
