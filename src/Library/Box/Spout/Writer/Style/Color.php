...
namespace App\Library\Box\Spout\Writer\Style;

use App\Library\Box\Spout\Writer\Exception\InvalidColorException;

/**
 * Class Color
 * This class provides constants and functions to work with colors
 *
 * @package App\Library\Box\Spout\Writer\Style
 */
class Color
{
     ...
     * @return void
     * @throws \App\Library\Box\Spout\Writer\Exception\InvalidColorException
     */
