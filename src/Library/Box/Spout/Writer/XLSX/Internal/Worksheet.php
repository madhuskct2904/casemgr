...
use App\Library\Box\Spout\Writer\Common\Helper\CellHelper;
use App\Library\Box\Spout\Writer\Common\Internal\WorksheetInterface;
...
EOD;
    ...
    /** @var \App\Library\Box\Spout\Writer\Common\Sheet The "external" sheet */
    ...
    /** @var \App\Library\Box\Spout\Common\Escaper\XLSX Strings escaper */
    ...
    /**
     * @param \App\Library\Box\Spout\Writer\Common\Sheet $externalSheet The associated "external" sheet
     * @param string $worksheetFilesFolder Temporary folder where the files to create the XLSX will be stored
     * @param \App\Library\Box\Spout\Writer\XLSX\Helper\SharedStringsHelper $sharedStringsHelper Helper for shared strings
     * @param bool $shouldUseInlineStrings Whether inline or shared strings should be used
     * @throws \App\Library\Box\Spout\Common\Exception\IOException If the sheet data file cannot be opened for writing
     */
    public function __construct($externalSheet, $worksheetFilesFolder, $sharedStringsHelper, $shouldUseInlineStrings)
    {
        ...
        $this->stringsEscaper = \App\Library\Box\Spout\Common\Escaper\XLSX::getInstance();
