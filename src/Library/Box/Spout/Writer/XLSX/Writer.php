...
namespace App\Library\Box\Spout\Writer\XLSX;

use App\Library\Box\Spout\Writer\AbstractMultiSheetsWriter;
use App\Library\Box\Spout\Writer\Style\StyleBuilder;
use App\Library\Box\Spout\Writer\XLSX\Internal\Workbook;

/**
 * Class Writer
 * This class provides base support to write data to XLSX files
 *
 * @package App\Library\Box\Spout\Writer\XLSX
 */
class Writer extends AbstractMultiSheetsWriter
{
     ...
     * @return Writer
     * @throws \App\Library\Box\Spout\Writer\Exception\WriterAlreadyOpenedException If the writer was already opened
     */
     ...
     *
     * @return void
     * @throws \App\Library\Box\Spout\Common\Exception\IOException If unable to open the file for writing
     */
     ...
     * @return void
     * @throws \App\Library\Box\Spout\Writer\Exception\WriterNotOpenedException If the book is not created yet
